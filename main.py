...
input_variable = "https://github.com/MarketingPipeline,"
...
def stream():
    ffmpeg_stream = 'ffmpeg -y -r 30 -f x11grab -s 640x480 -i :99 -g 300 -vcodec libx264 out.mp4'
...
for s in File_Names_List:
    ...
    try:
       ...
       # el = driver.find_element_by_tag_name('body')
        driver.save_screenshot(FilePath + ScreenshotPath)
